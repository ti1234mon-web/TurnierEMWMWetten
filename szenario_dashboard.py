...
# MIT 9 KPIs (inkl. FORM & STÄRKE), FIFA-RANKING-BASIERTER
# TEAM-KLASSIFIZIERUNG, SPIELSTIL-MODULATOR, MODULATION,
# POISSON & SZENARIO-ENGINE
# ============================================================
...
# ============================================================
# 1.1 FIFA-RANKING (aktuell, Stand 2026)
# ============================================================
...
def get_base_bonus_from_ranking(team_name: str) -> float:
    """Berechnet Basis-Bonus aus FIFA-Ranking (1-10 → 3.0, 11-20 → 2.5, etc.)"""
...
# ============================================================
# 1.3 STÄRKE-ANPASSUNG (manueller Faktor)
# ============================================================
...
class TeamScenario:
    ...
    def create_bits(self) -> List[int]:
        # Form und Stärke fließen NICHT in die Bits ein!
        return [
    ...
    def calculate_expected_goals(self) -> float:
        """
        Berechnet erwartete Torzahl mit:
        - KPI-Bonus × Team-Faktor
        - Basis-Bonus (aus FIFA-Ranking)
        - Stärke-Anpassung (manuell)
        - Form-Faktor
        - Spielstil-Modulator
        """
        # ─── BASIS-BONUS (aus FIFA-Ranking) ───
...
9. **Poisson** – Wahrscheinlichkeiten für Ergebnisse
""")
st.sidebar.markdown("---")
st.sidebar.caption("📅 Szenario Dashboard v5.0 (9 KPIs + FIFA-Ranking)")
