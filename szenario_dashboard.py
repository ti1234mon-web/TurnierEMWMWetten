...
# MIT TEAM-KLASSIFIZIERUNG & BASIS-BONUS
# ============================================================
...
# ============================================================
# 1.1 TEAM-KLASSIFIZIERUNG (Basis-Bonus)
# ============================================================
...
class TeamScenario:
    ...
    def calculate_expected_goals(self) -> float:
        """
        Berechnet die erwartete Torzahl basierend auf KPI-Bonus und Team-Basis-Bonus.
        """
        # Team-Faktor: Weltklasse = 1.0, Top-Nation = 0.9, etc.
        ...
        # KPI-Bonus wird mit Team-Faktor multipliziert + Basis-Bonus
        expected = (self.bonus * team_factor) + self.base_bonus * 0.5
        return max(0.0, min(expected, 5.0))
...
def get_best_guess(match: MatchScenario, max_goals: int = 5) -> Tuple[int, int]:
...
6. **Erwartete Tore (λ)** – (KPI-Bonus × Faktor) + Basis-Bonus
7. **Poisson** – Wahrscheinlichkeiten für Ergebnisse
""")
st.sidebar.markdown("---")
st.sidebar.caption("📅 Szenario Dashboard v3.0 (Team-Klassifizierung)")
