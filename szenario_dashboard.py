...
# ============================================================
# ALL-IN-ONE: CONFIG + MODELS + LOGIC (POISSON) + UI + APP
# ============================================================
...
# ============================================================
# 3. LOGIC (MIT POISSON + REALITÄTS-FILTER)
# ============================================================
...
def get_best_guess(match: MatchScenario, max_goals: int = 4) -> Tuple[int, int]:
    lambda_map = {
        0: 0.5, 1: 0.8, 2: 1.1, 3: 1.4, 4: 1.7, 5: 1.9, 6: 2.1, 7: 2.3
    }
...
# ============================================================
# 4. UI (Streamlit-Komponenten) – UNVERÄNDERT
# ============================================================
...
6. **Poisson-Verteilung** – Wahrscheinlichkeiten für Ergebnisse
7. **Best Guess** – das wahrscheinlichste Ergebnis
""")
st.sidebar.markdown("---")
st.sidebar.caption("📅 Szenario Dashboard v2.0 (Poisson)")
