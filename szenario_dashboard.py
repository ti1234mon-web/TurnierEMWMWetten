...
# MIT 9 KPIS, FIFA-RANKING, HISTORISCHEN DURCHSCHNITTSTOREN,
...
# ============================================================
# 1.2 HISTORISCHE DURCHSCHNITSTORE (pro Team)
# ============================================================
...
class TeamScenario:
    ...
    def calculate_expected_goals(self) -> float:
        ...
        # Maximale Steigerung basierend auf Teamstärke
        if hist_avg >= 2.5:
            max_addition = 2.0
        elif hist_avg >= 1.8:
            max_addition = 1.5
        ...
        # SDM: +0.3 zusätzlich, wenn Offensive stark + Defensive schwach
...
""")
st.sidebar.markdown("---")
st.sidebar.caption("📅 Szenario Dashboard v7.0 (mit historischen Durchschnittstoren)")
