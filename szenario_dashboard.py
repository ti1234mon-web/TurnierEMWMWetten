...
# MIT TEAM-KLASSIFIZIERUNG, SPIELSTIL-MODULATOR,
# MODULATION, SZENARIO-ENGINE, POISSON & GRAFIK
# ============================================================
...
# ============================================================
# 1.1 TEAM-KLASSIFIZIERUNG (ERWEITERTE LISTE)
# ============================================================
...
TEAM_CLASSES = {
    ...
    "England": 3.0,
    "Spanien": 3.0,
    "Italien": 3.0,  # EM, aber nicht WM 2026
...
# ============================================================
# 1.2 LAMBDA-MAP (max. 4.0 Tore)
# ============================================================

def get_lambda_from_expected(expected_goals: float) -> float:
    """
    Wandelt die erwartete Torzahl in einen Lambda-Wert für Poisson um.
    Maximal 4.0 Tore.
    """
    if expected_goals <= 0:
        return 0.0
...
class TeamScenario:
    ...
    def calculate_expected_goals(self) -> float:
        """
        Berechnet die erwartete Torzahl mit:
        - KPI-Bonus × Team-Faktor
        - Basis-Bonus
        - Spielstil-Modulator (Defensiv+Tief → 0.5, Aggressiv+Hoch → 1.3)
        """
        # Team-Faktor
        ...
        # Wenn Defensive schwach und trotzdem defensiv gespielt wird,
        # bleibt die erwartete Torzahl niedrig (weil sie nicht angreifen)
...
2. **7 KPIs** – je 2 Zustände
3. **Bits** – stark = 1, schwach = 0
4. **KPI-Bonus** – Anzahl der Bits (0–7)
5. **Team-Basis-Bonus** – Klassifizierung (1.0–3.0)
6. **Erwartete Tore (λ)** – mit Spielstil-Modulator
7. **Poisson** – Wahrscheinlichkeiten für Ergebnisse
""")
st.sidebar.markdown("---")
st.sidebar.caption("📅 Szenario Dashboard v3.0 (Team-Klassifizierung + Spielstil-Modulator)")
